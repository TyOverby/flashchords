...
export function PencilIcon({ size }) {
  return html`<${Icon} size=${size} d=${html`
    <path key="a" d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z" />
...
export function EraserIcon({ size }) {
  return html`<${Icon} size=${size} d=${html`
    <path key="a" d="m7 21-4.3-4.3c-1-1-1-2.5 0-3.4l9.6-9.6c1-1 2.5-1 3.4 0l5.6 5.6c1 1 1 2.5 0 3.4L13 21" />
    <line key="b" x1="7" y1="21" x2="21" y2="21" />
  `} />`;
}
